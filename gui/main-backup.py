# =============================================================
#		 Модуль <Графический пользовательский интерфейс>
# =============================================================
#		 @version   1.0
#		 @author    Лепов Алексей <Alexeylepov@gmail.com>
# =============================================================
...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label_info_natnum = customtkinter.CTkLabel(master=self.frame_body_natnum, text="Натуральные числа с нулем: \n(n; A[..]) - номер старшей позиции\n и массив цифр Цифра D (тип - целое)",
                                                 text_font=("Roboto Medium", -16))
        ...
        self.label_info_integer = customtkinter.CTkLabel(master=self.frame_body_integer, text="Целые числа (b, n; A[..]) - знак числа \n(1 — минус, 0 — плюс) номер старшей \nпозиции и массив цифр",
                                                 text_font=("Roboto Medium", -16))
        ...
        self.label_info_rational = customtkinter.CTkLabel(master=self.frame_body_rational, text="Рациональная числа (дроби) — пара \n(целое; натуральное), первое имеет \nсмысл числителя, второе - знаменателя",
                                                 text_font=("Roboto Medium", -16))
        ...
        self.label_info_polynual = customtkinter.CTkLabel(master=self.frame_body_polynual, text="Многочлен с рациональными коэффициентами \nm – степень многочлена и массив C \nкоэффициентов",
                                                 text_font=("Roboto Medium", -16))
        ...
        self.entry_polynual1 = customtkinter.CTkEntry(master=self.frame_body_polynual, width=120,
                                                      placeholder_text="Введите коэффициенты многочлена через <,>", text="")
        ...
        self.entry_polynual2 = customtkinter.CTkEntry(master=self.frame_body_polynual, width=120,
                                                      placeholder_text="Введите коэффициенты второго многочлена через <,>", text="")
        ...
        self.label_rad_MUL_Pxk_P = customtkinter.CTkLabel(master=self.frame_radio_polynual, height=20,
                                                          text="Умножение на число в степени",
                                                          text_font=("Roboto Medium", -14))
    ...
    def button_calculate_rational_event(self):
        try:
            if (self.radio_var_rational.get() == 0):
                self.label_res_rational.configure(text=str(RED_Q_Q(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()))))
            elif (self.radio_var_rational.get() == 1):
                self.label_res_rational.configure(text=str(INT_Q_B(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()))))
                ...
                self.label_res_rational.configure(text=str(TRANS_Q_Z(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()))))
            elif (self.radio_var_rational.get() == 4):
                self.label_res_rational.configure(text=str(
                    ADD_QQ_Q(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()), RationalNumber(self.entry_rational2_num.get(), self.entry_rational2_den.get()))))
            elif (self.radio_var_rational.get() == 5):
                self.label_res_rational.configure(text=str(
                    SUB_QQ_Q(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()), RationalNumber(self.entry_rational2_num.get(), self.entry_rational2_den.get()))))
            elif (self.radio_var_rational.get() == 6):
                self.label_res_rational.configure(text=str(
                    MUL_QQ_Q(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()), RationalNumber(self.entry_rational2_num.get(), self.entry_rational2_den.get()))))
            elif (self.radio_var_rational.get() == 7):
                self.label_res_rational.configure(text=str(
                    DIV_QQ_Q(RationalNumber(self.entry_rational1_num.get(), self.entry_rational1_den.get()), RationalNumber(self.entry_rational2_num.get(), self.entry_rational2_den.get()))))
        except ValueError:
        ...
        try:
            if (self.radio_var_polynual.get() == 0):
                self.label_res_polynual.configure(
                    text=str(ADD_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 1):
                self.label_res_polynual.configure(
                    text=str(SUB_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 2):
                self.label_res_polynual.configure(
                    text=str(MUL_PQ_P(Polynom(self.entry_polynual1.get()), RationalNumber(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 3):
                self.label_res_polynual.configure(text=str(
                    MUL_Pxk_P(Polynom(self.entry_polynual1.get()), RationalNumber(self.entry_polynual2.get()),
                              RationalNumber(self.entry_polynual3.get()))))
            elif (self.radio_var_polynual.get() == 4):
                self.label_res_polynual.configure(text=str(LED_P_Q(Polynom(self.entry_polynual1.get()))))
            elif (self.radio_var_polynual.get() == 5):
                self.label_res_polynual.configure(text=str(DEG_P_N(Polynom(self.entry_polynual1.get()))))
            elif (self.radio_var_polynual.get() == 6):
                self.label_res_polynual.configure(text=str(FAC_P_Q(Polynom(self.entry_polynual1.get()))))
            elif (self.radio_var_polynual.get() == 7):
                self.label_res_polynual.configure(
                    text=str(MUL_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 8):
                self.label_res_polynual.configure(
                    text=str(DIV_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 9):
                self.label_res_polynual.configure(
                    text=str(MOD_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 10):
                self.label_res_polynual.configure(
                    text=str(GCF_PP_P(Polynom(self.entry_polynual1.get()), Polynom(self.entry_polynual2.get()))))
            elif (self.radio_var_polynual.get() == 11):
                self.label_res_polynual.configure(text=str(DER_P_P(Polynom(self.entry_polynual1.get()))))
            elif (self.radio_var_polynual.get() == 12):
                self.label_res_polynual.configure(text=str(NMR_P_P(Polynom(self.entry_polynual1.get()))))
        except ValueError:
    ...
    def radio_natnums_event_0(self):
        self.radio_natnums_event2()
        self.label_info_natnum1.configure(text="Сравнение натуральных чисел: \n2 - если первое больше второго,\n0, если равно, 1 иначе.")
    def radio_natnums_event_1(self):
        self.radio_natnums_event1()
        self.label_info_natnum1.configure(text="Проверка на ноль: если число \nне равно нулю, то «true» иначе \n«false»")
    ...
    def radio_natnums_event_4(self):
        self.radio_natnums_event2()
        self.label_info_natnum1.configure(text="Вычитание из первого большего \nнатурального числа второго \nменьшего или равного")
    ...
    def radio_integer_event_1(self):
        self.radio_integer_event1()
        self.label_info_integer1.configure(text="Определение положительности числа \n(2 - положительное, 0 — равное \nнулю, 1 - отрицательное)")
    ...
    def radio_rational_event_1(self):
        self.radio_rational_event1()
        self.label_info_rational1.configure(text="Проверка на целое, если рациональное \nчисло является целым, то «да», \nиначе «нет»")
    ...
    def radio_polynual_event_6(self):
        self.radio_polynual_event1()
        self.label_info_polynual1.configure(text="Вынесение из многочлена НОК знаменателей \nкоэффициентов и НОД числителей")
